...
def main():
    ...
    for rep_i in range(args.num_repetitions):
        ...
        #modify hint
        if True:
            hint = np.load('/home/yhc/OmniControl/5sk.npy')[:116]
            ...
            model_kwargs['y'][text_key] = ['unconstrained' ]* len(model_kwargs['y'][text_key])
        ...
        if args.unconstrained:
            ...
            if 'hint' in model_kwargs['y']:
                ...
                hint = hint.reshape(hint.shape[0], hint.shape[1], 5, 2, 3)
